...
class PdoGsb
{
    ...
    private function __construct()
    {
        ...
        /*
          ...
          $this->connexion = new PDO(
              "mysql:host=" . $serveurs[0] . ";dbname=" . DB_NAME . ";charset=UTF8",
              DB_USER,
              DB_PWD);
          $this->connexion->query('SET CHARACTER SET utf8');
          ...
          try {
          $this->connexion = new PDO(
              "mysql:host=" . $serveurs[1] . ";dbname=" . DB_NAME . ";charset=UTF8",
              DB_USER,
              DB_PWD);
          $this->connexion->query('SET CHARACTER SET utf8');
    ...
    {
        $requetePrepare = $this->connexion->prepare(
            'SELECT visiteur.id AS id, visiteur.nom AS nom, visiteur.prenom AS prenom, fichefrais.mois AS mois '
